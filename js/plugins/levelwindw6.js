...
$gameMap.piller();
if(!$gameSwitches._data[89]){
$gameVariables._data[547] = -10;
}else{
$gameVariables._data[547] = -4;
};
if($gameSwitches._data[89]) $gameVariables._data[520] = 444;
$gameMap.pos_adjust();
$gameMap.name_terrain();
...
$gameVariables._data[751] == 45 || $gameVariables._data[751] == 39){ 
...
if($gameSwitches._data[258] || $gameSelfSwitches.value([this._mapId, num, "C"])){
...
if($gameSwitches._data[258]){
$gameVariables._data[519] = "3d_chestsp";
}else{
...
if($gamePlayer._direction == $gameSwitches._data[162]) $gameSwitches._data[258] = true;
};
};
};
};
...
if($gameVariables._data[751] == 92) $gameVariables._data[534] = "dnomi_house2";
if($gameVariables._data[751] == 91) $gameVariables._data[534] = "dnomi_house";
...
if($gameVariables._data[751] == 83) $gameVariables._data[534] = "kanban";
if($gameVariables._data[751] == 81 || $gameVariables._data[751] == 62) $gameVariables._data[534] = "rock";
...
if($gameVariables._data[751] == 14) $gameVariables._data[534] = "dnomi_house2";
...
if($gameVariables._data[751] == 88){
$gameVariables._data[534] = "waterin";
if(!$gameSwitches._data[9]) $gameVariables._data[534] = "npckishi";
